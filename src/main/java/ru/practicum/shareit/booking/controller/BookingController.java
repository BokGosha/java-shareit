...
public class BookingController {
    ...
    @GetMapping
    public List<BookingDto> getBookingsByBookerIdAndState(@RequestHeader("X-Sharer-User-Id") Long bookerId,
                                                          @RequestParam(defaultValue = "ALL") String state) {
        return bookingService.getBookingsByBookerIdAndState(bookerId, state);
    }

    @GetMapping("/owner")
    public List<BookingDto> getBookingsByOwnerIdAndState(@RequestHeader("X-Sharer-User-Id") Long ownerId,
                                                         @RequestParam(defaultValue = "ALL") String state) {
    ...
    public BookingDto getBookingById(@RequestHeader("X-Sharer-User-Id") Long bookerOrOwnerId,
